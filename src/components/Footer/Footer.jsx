        ...
        <div className="mx-auto mt-5 mb-4 text-center row d-flex center">
          ...
          <div className="mb-1 col-sm-12 col-md-6">
            <table style={{ marginLeft: 'auto', marginRight: 'auto' }}>
              <tbody>
                <tr>
                  <td width="60%"><Link className="mt-3 ml-2 row" to="/about">About</Link></td>
                  <td><Link className="mt-3 ml-3 row" to="/terms">Terms</Link></td>
                </tr>
                <tr>
                  <td><Link className="mt-3 ml-2 row" to="/policy">Policy</Link></td>
                  <td><a href="https://pages.razorpay.com/DonateRaahee" className="mt-3 ml-3 row" target="_blank" rel="noreferrer">Donate</a></td>
                </tr>
                <tr>
                  <td><Link className="mt-3 ml-2 row" to="/activities">Activities</Link></td>
