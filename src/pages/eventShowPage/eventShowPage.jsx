...
import { attendEvent, unattendEvent, fetchEventById, sendEmail } from '../../api/index';
...
const EventShowPage = ({ match, enqueueSnackbar }) => {
  const {
    params: { eventId },
  } = match;
      ...
      gapi.auth2
        ...
        .then(() => {
          ...
          request.execute((event) => {
            ...
            window.open(event.htmlLink, '_blank').focus();
          });
        });
    });
  };
            ...
            <div className="EventShowPage">
              {Object.keys(event).length > 0 && (
                <>
                  ...
                  <div id="testi" />
                  <Feedback id={eventId} item="events" />
                  <EventTestimonials />
                </>
              )}
            </div>
