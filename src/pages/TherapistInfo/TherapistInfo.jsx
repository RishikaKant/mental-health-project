...
function TherapistInfo() {
  ...
  useEffect(() => {
    fetchMhpById(mhpID).then((mhpD) => {
      const data = mhpD.data[0];
      setTherapist(data);
      setLanguages(data.languages?.split('$').join(', '));
      setLoading(false);
    });
    dispatch(getMhpFeedbacks(mhpID));
  }, []);
              ...
              <div style={{ padding: '0 15px' }}>
                <div className="introContainer">
                  ...
                  <ul className="therapistInfoContent">
                    ...
                    <li>
                      <button className="btn btn-secondary specific" onClick={copy} id="shareProfile">
                        {!copied ? 'Share Profile ' : 'Profile URL Copied '}
                ...
                <div className="therapist__info">
                  ...
                  <div id="work-experience">
                    {therapist.workEx && therapist.workEx.length > 0 && (
                      <h4>
                        Work Experience
                      </h4>
                    )}
                    <ul>
                      {therapist.workEx ? therapist.workEx.split('$').map((domain, i) => (
