  ...
  return (
    <div className="EventPage">
            ...
            <div className="main-heading">
              <div>
                ...
                <div className="buttons mt-5">
                  <Link to={upcomingEvents.length > 0 ? 'scroll' : 'pastScroll'} spy smooth duration={100} offset={-75} className="btn btn-secondary text-capitalize mr-md-4" style={{ boxShadow: 'none' }}>
                    Explore The Events
                  </Link>
      ...
      {upcomingEvents.length > 0 && (
        <div className="container" style={{ marginTop: '80px' }} id="scroll">
      ...
      <div className="container" style={{ marginTop: '80px' }} id="pastScroll">
        <div className="justify-content-between home-landing">
          <p className="landing-text">
            Past Events
          </p>
