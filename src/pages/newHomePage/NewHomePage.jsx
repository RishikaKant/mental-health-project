                  ...
                  <div className="main-heading mb-5">
                    <div>
                      <ul className="app-features my-lg-4 my-md-2 pl-0">
                        <li className="mb-2 color-gray">
                          Affordable sessions with verified therapists
                          {' '}
                        </li>
                        <li className="mb-2 color-gray">Extensive Library of resources </li>
                        <li className="mb-2 color-gray">Meditation and venting features </li>
                        <li className="mb-2 color-gray">Community as close knit as a family </li>
                        <li className="mb-2 color-gray">Mood trackers and guided journaling </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div key={blog.id} className="col-md-4 card-deck">
                  <div className="card card-cascade narrower mb-4">
                    ...
                    <div className="card-body card-body-cascade d-flex flex-column">
                      ...
                      <Link
                        className="btn purple-gradient mt-auto"
                        target="_blank"
                        rel="noreferrer"
                        to={'/blog/' + blog.id}
                      >
